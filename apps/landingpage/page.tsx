        ...
        >
          ...
          >
            <nav className="flex justify-between items-center max-w-6xl mx-auto">
              <Link href="/" className="text-xl font-light hover:text-blue-400 transition-all duration-300 ease-out">
                AndesOriCore
              </Link>
              <div className="space-x-4">
                <Link href="/login" className="relative px-4 py-2 text-sm text-gray-400 hover:text-blue-400 transition-all duration-300 ease-out rounded-full bg-black/20 backdrop-blur-sm border border-gray-800 hover:border-blue-900">Login</Link>
                <Link href="/signup" className="relative px-4 py-2 text-sm text-gray-400 hover:text-blue-400 transition-all duration-300 ease-out rounded-full bg-black/20 backdrop-blur-sm border border-gray-800 hover:border-blue-900">Sign Up</Link>
              </div>
            </nav>
          </motion.header>
          ...
          <main className="max-w-6xl mx-auto px-4 py-12 md:py-24 relative z-10">
            <section className="mb-24 space-y-12">
              ...
              >
                A web-based platform to analyze core samples with precision, traceability, and full control—no third parties, no delays.
              </motion.p>
              ...
              >
                <Button 
                  asChild
                  className="relative bg-black/20 backdrop-blur-sm text-blue-400 rounded-full px-8 py-6 text-lg font-light border border-blue-950 shadow-[0_0_15px_rgba(0,0,255,0.1)] hover:shadow-[0_0_25px_rgba(0,0,255,0.2)] hover:border-blue-900 transition-all duration-500 ease-out group overflow-hidden"
                >
                  <Link href="/signup">
                    <span className="relative z-10">See How It Works</span>
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-950/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 ease-out" />
                  </Link>
                </Button>
                <Button 
                  variant="outline" 
